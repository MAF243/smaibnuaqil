    ...
    if (empty($email_username)) {
        ...
        if ($stmt) {
            ...
            $message = '<div class="alert alert-danger" role="alert">Terjadi kesalahan database saat mencari akun Anda. Mohon coba lagi nanti.</div>';
             // Untuk keamanan, bisa tampilkan pesan sukses generik
             // $message = '<div class="alert alert-success" role="alert">Jika nomor telepon ditemukan, instruksi reset password telah dikirim.</div>';
        }
    }
}
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-4">Cukup masukkan alamat email atau username Admin Anda di bawah ini dan kami akan kirimkan link untuk mereset password Anda!</p>
                                    </div>
